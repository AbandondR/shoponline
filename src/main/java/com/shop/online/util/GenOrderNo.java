...
public class GenOrderNo {
     ...
     * 交易类别头
     */
    private static final String TRADE_ORDER = "5";
    /**
     * 随即编码
     */
    ...
    public static String getTradeCode(Long userId) {
        return TRADE_ORDER + getCode(userId);
    }
    ...
    public static void main(String[] args) throws UnsupportedEncodingException {
        for(int i=0; i< 10; i++) {
            String code = getOrderCode(23923L);
