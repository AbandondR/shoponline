...
<head>
	...
	<link rel="stylesheet" href="/css/back/admin/commodityList.css">
	<link rel="stylesheet" href="/css/back/admin/adminCommon.css">
	<link rel="stylesheet" href="/css/back/admin/commodityDetail.css">
	...
	<script type="text/javascript" src="/js/back/admin/commodityDetail.js"></script>
